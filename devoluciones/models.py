...
class Devolucion(models.Model):
    ...
    detalle_pedido = models.ForeignKey(DetallePedido, on_delete=models.SET_NULL, null=True, blank=True, related_name='devoluciones')
    ...
    precio_devolucion = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
