...
class PedidosAvanzadosIntegrationTestCase(TestCase):
    ...
    def test_orden_creation_with_audit(self):
        """Test that orden creation triggers audit logging"""
        initial_audit_count = LogAuditoria.objects.count()
        ...
        # Verify audit log was created (if audit integration is implemented)
        # This might be implemented in the views later
...
class PedidosAvanzadosPerformanceTestCase(TestCase):
    ...
    def test_dashboard_query_optimization(self):
        """Test dashboard doesn't execute excessive queries"""
